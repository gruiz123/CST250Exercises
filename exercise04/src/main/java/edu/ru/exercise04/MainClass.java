...
public class MainClass {
    ...
    public static void main(String [] args){
        ...
        System.out.println("Average execution time for implementation 1: " + average_1 + " nano seconds.");
        ...
        System.out.println("Average execution time for implementation 2: " + average_2 + " nano seconds.");
